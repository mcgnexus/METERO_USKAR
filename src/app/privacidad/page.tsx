  ...
  return (
    <main className="mx-auto w-full max-w-3xl flex-1 px-5 py-10 text-slate-800">
      ...
      <section className="mt-8 space-y-4 text-sm leading-7">
        ...
        <p>El sitio puede tratar datos técnicos de navegación necesarios para prestar el servicio y mantener su seguridad. Si lo aceptas en el aviso de analítica, medimos métricas de rendimiento de la página (LCP, INP y CLS) junto con la ruta, el municipio, el tipo de dispositivo y el tipo de conexión, de forma agregada y sin identificarte. Puedes rechazarlas o cambiar tu decisión en cualquier momento desde el botón <strong>⚙️ Analítica</strong>. Si activas las notificaciones, se guarda la suscripción push, que incluye el endpoint del navegador y las claves técnicas necesarias para enviar avisos. No se solicita nombre, teléfono ni ubicación precisa para activar este servicio.</p>
