...
const SOURCE_META = {
  aemet: { label: 'AEMET', tone: 'bg-rose-100 text-rose-800', desc: 'Alerta oficial de la Agencia Estatal de Meteorología' },
      ...
      >
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div>
              ...
              <p className="mt-0.5 text-sm capitalize opacity-75">{alarm.audience}</p>
            </div>
          </div>
        ...
        <div className="mt-5 space-y-4">
          ...
          <section>
            ...
            <p className="mt-2 text-sm font-bold capitalize">{alarm.audience}</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-sm leading-6">
              ...
              {alarm.level === 'precaucion' && 'Preparar medidas preventivas. Monitorizar evolución en las próximas horas.'}
              {alarm.level === 'aviso' && 'Mantenerse informado. No requiere acción inmediata pero se recomienda vigilancia.'}
            </p>
          </section>
        </div>
      </div>
